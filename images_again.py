...
image_no_1 = ImageTk.PhotoImage(Image.open("Chord Pictures/Bb.PNG"))
image_no_2 = ImageTk.PhotoImage(Image.open("Chord Pictures/C.PNG"))
image_no_3 = ImageTk.PhotoImage(Image.open("Chord Pictures/C7.PNG"))
image_no_4 = ImageTk.PhotoImage(Image.open("Chord Pictures/Dm.PNG"))
image_no_5 = ImageTk.PhotoImage(Image.open("Chord Pictures/F.PNG"))
